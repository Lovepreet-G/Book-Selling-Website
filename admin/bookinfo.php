<?php
    ...
    $query1 = "select * from admin_book_table";
    ...
    <section id="display" class="container my-5 pt-5">
        <div class="row ">
            ...
            <div id="book-details" class="col-lg-6 col-md-12 col-12">
                    ...
                    <h4 class="mb-3"><?php echo "Quantity: ".$quantity; ?></h4>
                    <?php
                    
                        echo '<h5 class="mb-3 d-inline">Posted: </h5>';
                        
                        if($posted == 't') {
                            echo  "<a href=\"post.php?id=".$_GET['id']."\"  name=\"user_id\" class=\"btn btn-success mb-3\">True</a>";
                        } else {
                            echo  "<a href=\"post.php?id=".$_GET['id']."\"  name=\"user_id\" class=\"btn btn-danger mb-3\">False</a>";
                        }
                        echo "<br>";
                    ?>
                    <a href="deleteBook.php?id=<?php echo $user_id?>"  name="user_id" class="btn btn-danger mb-3">Delete</a>
                    <a href="books.php" class="btn btn-primary mb-3">Back</a>
            </div>
        </div>
